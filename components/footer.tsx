...
export function Footer() {
  return (
    <footer className="relative bg-[#0a0a0a] border-t border-border">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/60 leading-relaxed mb-8 max-w-sm">
              Pioneering the future of design through artificial intelligence.
              We create brands that evolve, adapt, and inspire.
            </p>
          ...
          {/* Services Column */}
          <div>
            <h4 className="text-sm font-bold uppercase text-white tracking-widest mb-6">
              Services
            </h4>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/40">
            © 2026 Nexus AI Studio. All rights reserved.
          </p>
